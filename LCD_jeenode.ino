...
// LCD_Jeenode for kitchen
// a few small changes to accommodate my 16x2 LCD display
...
void setup() {
    ...
    lcd.createChar(1, percentChar);     // new percent
...
void loop() {
    ...
    if (rf12_recvDone()) {
        ...
        if (hdr == 5) {  // Gather data from Node 5
        ...
        if (hdr == 10) {  // Gather data from Node 10
